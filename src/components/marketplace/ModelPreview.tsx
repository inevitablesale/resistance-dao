...
export const ModelPreview: React.FC<ModelPreviewProps> = ({ 
  ...
  useEffect(() => {
    ...
    // Clean any previous error state when attempting to load a new model
    setLoading(true);
    setError(null);
    ...
    try {
      ...
      console.error('General rendering error:', err);
    ...
    >
      ...
      {error && (
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/70">
          <AlertTriangle className="h-8 w-8 text-apocalypse-red mb-2" />
          <div className="text-apocalypse-red text-center p-4">
            <p className="text-lg">Failed to load 3D model</p>
