    ...
    <section className="py-16">
      <div className="container px-4">
        <div className="max-w-3xl mx-auto text-center mb-12">
          <h2 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-orange-500 via-orange-200 to-blue-400 mb-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="p-6 rounded-lg bg-black/30 backdrop-blur border border-orange-500/20 hover:border-orange-500/40 transition-colors">
            <Crown className="w-8 h-8 text-orange-400 mb-4" />
