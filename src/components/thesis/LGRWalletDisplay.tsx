  ...
  return (
    <div className={className}>
      <Button
        variant="outline"
        size="sm"
        className="bg-[#161920] border-gray-800 text-white w-full"
        onClick={() => setIsOpen(!isOpen)}
      >
        <div className="flex items-center gap-2">
          <div className="w-2 h-2 rounded-full bg-green-500" />
          <span>{formatBalance(currentBalance)} LGR</span>
        </div>
      </Button>

      {isOpen && (
        <Card className={cn(
          "bg-black border-white/10 overflow-hidden p-6 space-y-6 mt-2 animate-in fade-in slide-in-from-bottom-5",
        )}>
          <div className="space-y-3">
            <div className="relative w-full">
              <Button
                variant="outline"
                className="w-full h-14 bg-white/5 border-white/10 hover:bg-white/10 text-white font-medium relative"
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <p className="text-2xl font-bold text-white">
                    {formatBalance(currentBalance)} LGR
                  </p>
