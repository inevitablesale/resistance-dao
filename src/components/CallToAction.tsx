      ...
      <div className="container px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-4">
            We're building a decentralized protocol to power the next generation of professional service firms through blockchain technology.
          </p>
          <p className="text-lg text-gray-400 mb-12">
            Participate in our token distribution to help build the infrastructure for decentralized professional services.
          </p>
