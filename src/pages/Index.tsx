        ...
        <div className="glass-card p-8 rounded-2xl backdrop-blur-lg bg-white/5 border border-white/10">
          <div className="flex gap-4 justify-center mb-8">
            <div className="dynamic-widget-wrapper">
              <DynamicWidget buttonClassName="bg-white text-purple-900 hover:bg-purple-100 transition-colors px-6 py-2 rounded-lg font-medium" buttonText="Mint Ledger NFT" />
            </div>
